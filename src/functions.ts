...
/** The twelve curves, chosen for how they look once revolved. */
export const FUNCTIONS: Fn[] = [
  ...
  { id: "tan", latex: "y = \\tan x", f: Math.tan, domain: [-1.2, 1.2], turns: 5, hue: "#FF4D6D", label: "TANGENT FIELD" },
  { id: "ln", latex: "y = \\ln x", f: Math.log, domain: [1.0, 6], turns: 5, hue: "#36C5F0", label: "LOG FIELD" },
  { id: "damped", latex: "y = e^{-x/4}\\cos 3x", f: (x) => Math.exp(-x / 4) * Math.cos(3 * x), domain: [0, 4 * Math.PI], turns: 7, hue: "#00F5D4", label: "DAMPED FIELD" },
];
